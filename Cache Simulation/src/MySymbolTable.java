...
// included HashMap for implementing the MySymbolTable
import java.util.HashMap;
public class MySymbolTable<SymbolType, RecordType> implements SymbolTable<SymbolType, RecordType>
{
	private HashMap<SymbolType, RecordType> table;
	
	public MySymbolTable()
	{
		table = new HashMap<>(); // Creating new table as HashMap in the constructor
	}
